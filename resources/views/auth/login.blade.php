            ...
            <div class="col-lg-7 col-12">
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="md-float-material">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" id="pass" placeholder="Enter Password">
                            <div class="form-control-icon">
                        ...
                        <div class="form-check form-check-lg d-flex align-items-end">
                            <input class="form-check-input me-2" type="checkbox" id="check" onclick="showPass();">
